...
public class DoiSoatFileVTMoi {
    public static void main(String[] args) throws IOException {


        String date = "17-02-2023";
        String dateCntt = "02/17/2023";
...
//		Set<String> cntt_vtlTransIds = new HashSet<String>();
        ...
        // vtlTransIds
        String dateVT2 =  LocalDate.now().minusDays(countDate).format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));

        for (String line : lines1) {
            String[] sps = line.split(",");
//			String[] sps = line.split("\t");
//            String requestDate = sps[3];
            String requestDate = "13-12-2022";
...
//		System.out.println("**************************************************************************************");
        ...
        for (String line : lines3) {
            ...
            if (transDt.contains(dateCNTT1) || transDt.contains(dateCntt +" 00:00:00") || transDt.contains(dateCNTT3)) {
